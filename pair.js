        ...
        sock.ev.on("connection.update", async (update) => {
            ...
            if (connection === "open") {
                ...
                try {
                    ...
                    const sessionId = "Ali asad~" + base64;

                    await sock.sendMessage(sock.user.id, { text: sessionId });

                    const successMsg = {
                        text:
                            `🚀 *ALI asad Session Created!*\n\n` +
                            `▸ *Never share* your session ID\n` +
                            `▸ Join our WhatsApp Channel\n` +
                            `▸ Report bugs on GitHub\n\n` +
                            `_Powered by Ali asad\n\n` +
                            `🔗 *Useful Links:*\n` +
                            `▸ GitHub: https://github.com/Aliasad189\n` +
                            `▸ https://whatsapp.com/channel/0029VbATSM74dTnMw4evnN13`,
                        contextInfo: {
